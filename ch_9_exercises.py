...
birthdays = {'Meri': 'May 16', 'Kathy': 'July 14', 'Jyotsna': 'July 26', 'Gaurav': 'August 31', 'Mishka': 'November 24'}
...
for key in miles_ridden:
    print(key, ": ", miles_ridden.get(key))
...
if "Mon" in days:
    print('The Mon is in the days set')
else:
    print('The Mon is not in the days set')
